...
class Test_workflow:
    ...
    def test_set_up(self):
        ...
        login = {
            "localhost": {"user": f"{username}", "host": "local"},
            "rivanna": {"user": f'{username}', "host": f"{host}"},
...
class todo:
    ...
    #         elif node.kind == 'ssh':
    #
    #         elif node.kind == 'slurm':
    #             raise NotImplementedError
    #
    #         else:
    #             raise ValueError('This kind of job has not yet had the .sh test file implemented')
    #
    #
    #     assert True
